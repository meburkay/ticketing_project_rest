...
@RestControllerAdvice//this used for exception handling and the response is jason or xml. For view return we use @ControllerAdvice annotation.
public class GlobalExceptionHandler {


    @ExceptionHandler(TicketingProjectException.class)//Whenever TicketingProjectException is throws execute this method.
    ...
    public ResponseEntity<ResponseWrapper> genericException(Throwable e, HandlerMethod handlerMethod) {
        ...
        //At this if statement we define that if I use my custom annotation exception handling use this otherwise use the other part for handling.
